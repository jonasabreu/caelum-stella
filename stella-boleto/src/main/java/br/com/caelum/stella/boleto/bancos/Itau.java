...
public class Itau implements Banco {
	...
	public String geraCodigoDeBarrasPara(Boleto boleto) {
		...
		codigoDeBarras.insert(38, dvGenerator.geraDVMod10(codigoDeBarras.substring(30, 38)));

		codigoDeBarras.insert(29, dvGenerator.geraDVMod10(codigoDeBarras.substring(30, 38).concat(
